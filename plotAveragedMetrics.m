...
%
% DFA alpha1/alpha2/alphaFull below are whole-trial scalars (one value per
% file, not a windowed series like hrv_series), so their seriesField/
% timeField are left empty on purpose -- plotWindowedMetrics.m already
% skips any metric missing both, which is correct here since there is no
% genuine windowed DFA series to plot.
    specs = [ ...
        ...
        ms('DFA alpha1',     '',    '',    '_HRVMeasures.mat', 'dfa_alpha1',         '',                   '',                  'auto', NaN); ...
        ms('DFA alpha2',     '',    '',    '_HRVMeasures.mat', 'dfa_alpha2',         '',                   '',                  'auto', NaN); ...
        ms('DFA alphaFull',  '',    '',    '_HRVMeasures.mat', 'dfa_alphaFull',      '',                   '',                  'auto', NaN) ];
end
